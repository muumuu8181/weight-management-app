            ...
            <div class="input-card">
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                        ...
                        <button type="button" class="timeframe-btn" data-timeframe="28週間" onclick="${this.containerId}_selectTimeframe('28週間')" style="background: #8b0000; color: white; border: none; padding: 6px 12px; border-radius: 5px; cursor: pointer; font-size: 12px; opacity: 0.7;">🏢 28週間</button>
